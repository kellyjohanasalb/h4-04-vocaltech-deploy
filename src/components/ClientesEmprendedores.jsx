...
const HeroButtons = () => {
    ...
    return (
        <div className="flex flex-wrap justify-center gap-4 px-4 mt-6 sm:px-6">
            <button
                className="flex items-center justify-center gap-2 h-[46px] px-4 rounded-[16px] bg-[#0F0F0F] hover:bg-[#1a1a1a] text-white font-bold text-sm sm:text-base"
                onClick={() => window.open("https://calendar.google.com/calendar/render?action=TEMPLATE&text=Reunión+con+un+experto&details=Agenda+una+reunión+con+nuestro+experto+para+hablar+sobre+tu+proyecto.&location=Online&dates=20250212T150000Z/20250212T160000Z", "_blank")}
            >
            ...
            <button
                ...
                onClick={() => navigate("/form-emprendedor")}
            >
