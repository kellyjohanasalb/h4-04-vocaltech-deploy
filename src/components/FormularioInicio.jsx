...
import logo from "../assets/icons/VocalTech.png"; // Asegúrate de que el nombre sea correcto
            ...
            <div className="w-full h-full max-w-5xl p-6 ">
                ...
                <div className="mb-4">
                    <button
                        ...
                        className="flex items-center text-black transition-colors hover:text-gray-800"
                    >
                        <FaArrowLeftLong className="w-6 h-6 mr-2" />
                ...
                <div className="flex flex-col flex-wrap justify-center gap-4 mt-6 sm:flex-row sm:gap-6">
                    ...
                    <button
                        ...
                        className="w-full sm:w-[250px] px-6 py-3 text-base sm:text-lg flex justify-center items-center gap-2 rounded-full border bg-[#C415D7] text-white font-medium transition-transform hover:scale-105"
                    >
                        Soy Emprendedor
                    </button>
                    ...
                    <button
                        ...
                        className="w-full sm:w-[250px] px-6 py-3 text-base sm:text-lg flex justify-center items-center gap-2 rounded-full text-white font-medium bg-gradient-to-r from-[#6A11CB] to-[#2575FC] bg-lightgray bg-blend-multiply transition-transform hover:scale-105"
                    >
