        ...
        <div className="grid grid-cols-4 gap-8 w-full">
          ...
          <div className="col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <img src={infrastructure} alt="infrastructure" className="w-6 h-6" />
          ...
          <div className="col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <img src={Microphone} alt="Microphone" className="w-6 h-6" />
              <h2 className="text-lg font-semibold text-stone-600">
                Comunicación y liderazgo
              </h2>
            </div>
          ...
          <div className="col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <img src={CPU} alt="CPU" className="w-6 h-6" />
              <h2 className="text-lg font-semibold text-stone-600">
                Tecnología y talento
              </h2>
            </div>
          ...
          <div className="col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <img src={Round} alt="Round" className="w-6 h-6" />
              <h2 className="text-lg font-semibold text-stone-600">
                Combinado
              </h2>
            </div>
